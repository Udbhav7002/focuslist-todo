/**
 * @fileoverview Lightweight SVG icon components for the FocusList application.
 * Replaces the heavy lucide-react dependency (~1350 modules) with minimal
 * inline SVGs to optimize bundle size and improve First Contentful Paint.
...
interface IconProps {
  ...
  className?: string;
  /** Accessible label for the icon. If omitted, icon is treated as decorative. */
  'aria-hidden'?: boolean;
}

/**
 * Plus circle icon for the "Add Task" button.
 */
...
/**
 * Empty circle icon for incomplete tasks.
 */
export const CircleIcon: React.FC<IconProps> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
    <circle cx="12" cy="12" r="10" />
  </svg>
);
...
/**
 * Check (checkmark) icon for save actions.
 */
...
/**
 * X (close) icon for cancel actions.
 */
...
/**
 * Keyboard icon for shortcuts panel toggle.
 */
export const KeyboardIcon: React.FC<IconProps> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
